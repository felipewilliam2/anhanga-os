...
export default function SignupPage({ rpcStub }: SignupPageProps) {
  ...
  const usernameError =
    username && !/^[a-z0-9_-]+$/i.test(username)
      ? "Apenas letras, números, sublinhados e hifens"
      : undefined;
      ...
      return (
        ...
        >
          <p className="text-sm text-kumo-danger text-center">
            Não foi possível carregar as configurações de implantação.
          </p>
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-kumo-base px-4">
        ...
        <p className="text-sm text-kumo-subtle text-center">
          {connectionLost ? "Não foi possível conectar ao servidor. Tentando novamente…" : "Carregando…"}
        </p>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-kumo-base px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-kumo-subtle mt-1">Crie sua conta</p>
        </div>
        ...
        {!signupsEnabled && (
          <Banner
            ...
            className="mb-4"
          >
            O cadastro de novas contas está desativado nesta implantação.
          </Banner>
        )}
          ...
          <div className={passwordAuthEnabled ? "mt-6" : ""}>
            {passwordAuthEnabled && (
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs text-kumo-subtle">ou</span>
                <div className="h-px flex-1 bg-kumo-line" />
              </div>
            )}
