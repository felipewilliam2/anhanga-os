...
function ModelRow({
  ...
  return (
    <div
      ...
      title={isQuick ? 'Modelo rápido. Clique para limpar' : 'Clique para definir como modelo rápido'}
        ...
        <DropdownMenu>
          ...
          <DropdownMenu.Content className={MENU_CONTENT}>
            <DropdownMenu.Item onClick={onSetQuick} className={MENU_ITEM}>
              ...
              {isQuick ? 'Limpar modelo rápido' : 'Definir como modelo rápido'}
            </DropdownMenu.Item>
            {!isBuiltIn && (
...
function ProvidersPage() {
  ...
  const handleDelete = async (model: AiChatAuthorInfo) => {
    if (!confirm(`Excluir "${model.name}"? Isso não pode ser desfeito.`)) return
    ...
    try {
      ...
      toasts.add({ title: 'Falha ao excluir provedor', variant: 'error' })
    } finally {
      setDeletingId(null)
    }
  }
  ...
  const handleSetQuick = async (modelId: string) => {
    ...
    try {
      ...
      toasts.add({ title: 'Falha ao atualizar o modelo padrão', variant: 'error' })
    }
  }
    ...
    <div className="mx-auto flex h-full w-full max-w-4xl flex-col px-6 sm:px-10">
      <header className="flex items-end justify-between gap-4 px-3 pb-3 pt-10">
        <div className="min-w-0">
          <h1 className="text-2xl font-semibold tracking-tight text-kumo-default">Provedores de IA</h1>
          <p className="mt-1 text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle">
            Configure os modelos de IA disponíveis para seus espaços de trabalho.
          </p>
        </div>
            ...
            {gatewayMode && (
              <Notice>
                ...
                <span>
                  ...
                  integrados são gerenciados pela sua implantação. Você ainda pode adicionar modelos
                  personalizados com seus próprios tokens de API.
                </span>
              </Notice>
            )}
              ...
              <Notice>
                ...
                <span>
                  ...
                  {quickModel
                    ...
                    : 'nenhum definido.'}{' '}
                  Usado para tarefas rápidas, como gerar títulos de conversas. Clique em um modelo para
                  defini-lo.
                </span>
              </Notice>
            )}
          ...
          <div className="flex flex-col items-center gap-3 px-3 py-16 text-center">
            ...
            <div>
              ...
              <p className="mt-1 text-[13px] leading-[18px] text-kumo-subtle">
                Adicione um provedor para começar a construir espaços de trabalho com IA.
              </p>
            </div>
            <button type="button" onClick={() => setSheetOpen(true)} className={PRIMARY_BTN}>
              <Plus size={14} weight="bold" />
