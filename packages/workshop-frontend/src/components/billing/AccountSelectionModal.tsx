    ...
    <Dialog.Root open role="alertdialog">
      <Dialog className="p-6 sm:w-[480px]" size="base">
        <Dialog.Title className="text-lg font-semibold mb-2 flex items-center gap-2">
          ...
          Escolha uma conta do Cloudflare
        </Dialog.Title>

        <div className="space-y-4">
          <p className="text-sm text-kumo-subtle">
            Sua conexão com o Cloudflare tem acesso a várias contas. Selecione aquela cujos créditos
            devem ser cobrados pelo uso além do nível gratuito.
          </p>
          ...
          {accounts === null ? (
            ...
            <Radio.Group
              ...
              disabled={saving}
            >
              <Radio.Legend className="sr-only">Conta do Cloudflare</Radio.Legend>
              {accounts.map((a) => (
